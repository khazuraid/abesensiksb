...
export const DeviceSchema = z.object({
	...
	errorDelay: z.number().default(60),
	isOnline: z.boolean().default(false),
	isBlocked: z.boolean().default(false),
	stamp: z.string().optional().default("0"),
	opStamp: z.string().optional().default("0"),
	...
	totalFingerprints: z.number().nullable().optional(),
	totalAttendances: z.number().nullable().optional(),
	deviceTimezone: z.string().optional().default("7"),
