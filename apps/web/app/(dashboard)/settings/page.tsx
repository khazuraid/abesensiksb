...
import { Bot, MessageCircle, Save, Check } from "lucide-react";
			...
			<div className="adms-card p-0 overflow-hidden">
				...
				<div className="p-6 space-y-8">
					...
					<div className="space-y-2">
						<label className="block font-sans text-[11px] font-semibold text-[#111c2d] uppercase tracking-wider">
							Bot Token
						</label>
						<input
							type="password"
					...
					<div className="space-y-2">
						...
						<input
							...
							placeholder="Masukkan URL API Hari Libur"
							className="w-full bg-white text-[#111c2d] border border-[#bdc8ce] rounded-lg px-4 py-3 text-[14px] focus:outline-none focus:border-[#00647c] focus:ring-1 focus:ring-[#00647c] transition-shadow placeholder:text-[#6e797e]"
						/>
						<p className="font-sans text-[11px] text-[#6e797e] mt-1">
							Endpoint API untuk menarik kalender hari libur nasional (contoh:
							https://api-harilibur.mengkodingkan.com/api)
						</p>
					</div>
					...
					<div className="space-y-4">
						<label className="block font-sans text-[11px] font-semibold text-[#111c2d] uppercase tracking-wider mb-4">
							Notifikasi
						</label>
						...
						<label className="flex items-center gap-3 cursor-pointer group">
							<div className="relative flex items-center justify-center w-5 h-5">
								...
								/>
								<Check className="text-white absolute w-3.5 h-3.5 pointer-events-none opacity-0 peer-checked:opacity-100 transition-opacity" strokeWidth={3} />
							</div>
